        ...
        <div>
            <div className="header-wrapper">
                ...
                <div className="navigation">
                    {role === 'defaultUser' ? <Link className="nav-item">Ваши отклики</Link> : <Link className="nav-item">Приглашения</Link>}
                    {role === 'defaultUser' ? <Link className="nav-item">Приглашения</Link> : <Link className="nav-item">Входящие заявки</Link>}
